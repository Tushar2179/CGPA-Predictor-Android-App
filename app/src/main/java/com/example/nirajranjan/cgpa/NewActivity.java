    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<theory;i++)
        {
           ...
           // surveytitle.setBackgroundColor(Color.parseColor("#3F51B5"));
            ...
            surveytitle.setText("Enter deatils for Theory paper");
...
for(j=0;j<sub1;j++)
{
    ...
    ed[j].setBackgroundColor(Color.parseColor("#fd558f"));
    ed[j].setGravity(View.TEXT_ALIGNMENT_GRAVITY);
    ed[j].setTextColor(Color.parseColor("#ffffff"));
    ed[j].setTypeface(null, Typeface.BOLD);
    ed[j].setTextSize(18);
    ed[j].setHint("Enter Marks for Theory "+ edittextcount);
    ed[j].setMinimumWidth(140);
    ...
    mainLinear.addView(ed[j]);
        ...
        for(int i=0;i<practical;i++)
        {
            ...
            surveytitle.setTypeface(null, Typeface.BOLD);
            surveytitle.setTextSize(18);
            surveytitle.setText("Enter deatils for Practical paper");
...
//FOR PRACTICAL PAPER
        ...
        for(k=0;k<sub2;k++)
        {
            ...
            ed2[k].setBackgroundColor(Color.parseColor("#baffff"));
            ed2[k].setGravity(View.TEXT_ALIGNMENT_GRAVITY);
            ed2[k].setTextColor(Color.parseColor("#ffffff"));
            ed2[k].setTypeface(null, Typeface.BOLD);
            ed2[k].setTextSize(18);
            ed2[k].setHint("Enter Marks for Practical "+ textcount);
